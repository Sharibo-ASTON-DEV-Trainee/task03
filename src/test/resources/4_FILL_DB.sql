...
VALUES('tomas24@mai.ru', 'Tomas', 'usaForever123');
INSERT INTO alexej_krawez_todo_db.users (email, login, `password`)
VALUES('ivan_pupkin@gmail.com', 'Ivan', 'donotpupkin');
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'breakfast', '2022-12-30 09:26:00', '8888Bacon_sandwich.jpg', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'training', '2022-12-30 09:28:00', 'null', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'lunch', '2022-12-30 09:40:34', '6633Pasta_salad.jpg', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'KENO: 18 21 23 2 49 37 26 43 41 45\\n20 52 28 47 17 5 30 25 48 38', '2022-12-30 10:42:16', 'null', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'training', '2022-12-30 10:48:48', 'null', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'dinner', '2022-12-30 10:54:03', '2212Ratatouille_sheet_pan_dinner_with_sausage.png', 2);
INSERT INTO alexej_krawez_todo_db.notes (user_id, note, `date`, file_path, status)
VALUES(2, 'anime: megalo box s03-06', '2022-12-30 11:01:28', 'null', 2);
INSERT INTO alexej_krawez_todo_db.users (email, login, password)
